...
class EnhancedPianoTrainer:
    def __init__(self):
        ...
        self.midi_practice = MIDIPracticeMode(
            self.piano_view, self.sound_engine, self.midi_loader
        )
        ...
        # Menu state
        self.in_menu = True
        self.menu_options = ["Regular Practice", "MIDI Practice", "Settings", "Exit"]
    ...
    def draw_menu(self):
        ...
        instructions = self.font.render(
            "Use UP/DOWN arrows to navigate, ENTER to select", True, self.GRAY
        )
